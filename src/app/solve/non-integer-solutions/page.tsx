...
import { generateNonIntegerInstance, Mode } from "@/lib/skills/nonIntegerSolutions";
...
export default function NonIntegerSolutionsPage() {
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "48px 24px 80px" }}>
      ...
      <StepSolver
        key={modeChoice}
        generate={() => generateNonIntegerInstance(modeChoice)}
        skillName="Fraction / decimal solutions"
      />
    </div>
  );
}
